...
const ItemListView = () => __webpack_require__.e(/*! import() */ 11).then(__webpack_require__.bind(null, /*! ./components/ItemListView.vue */ "./resources/js/src/views/apps/eCommerce/components/ItemListView.vue"));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    wishListButtonClicked(item) {
      // Toggle in Wish List
      if (this.isInWishList(item.objectID)) this.$router.push('/apps/eCommerce/wish-list').catch(() => {});else {
