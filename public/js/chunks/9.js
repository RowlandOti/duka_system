  ...
  watch: {
    isSidebarActive(val) {
      ...
      if (Object.entries(this.data).length === 0) {
        ...
        let _JSON$parse = JSON.parse(JSON.stringify(this.data)),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  fetchDataListItems({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/data-list/products").then(response => {
  ...
  updateItem({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].post(`/api/data-list/products/${item.id}`, {
        item: item
      }).then(response => {
  ...
  removeItem({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].delete(`/api/data-list/products/${itemId}`).then(response => {
