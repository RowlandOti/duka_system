...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    VuePerfectScrollbar: (vue_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_5___default())
  },

  created() {
    this.$store.registerModule('todo', _store_todo_moduleTodo_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
    this.setSidebarWidth();
    let filter = this.$route.params.filter; // Fetch Tasks
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  fetchTags({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/apps/todo/tags").then(response => {
  ...
  updateTask({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].post(`/api/apps/todo/task/${task.id}`, {
        task: task
      }).then(response => {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  getTask: state => taskId => state.tasks.find(task => task.id == taskId) // getTodosBySection: state => (sectionId) => state.todoArray.filter((task) => task.sectionId == sectionId),
