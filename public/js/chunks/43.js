...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    VuePerfectScrollbar: (vue_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_3___default())
  },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  fetchTags({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/apps/email/tags").then(response => {
  ...
  fetchMeta({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/apps/email/meta").then(response => {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  MOVE_MAILS_TO(state, payload) {
    payload.emailIds.forEach(mailId => {
      const mailIndex = state.mails.findIndex(mail => mail.id == mailId); // Update draft meta
      // If moving from draft mailFolder decrease draft meta by removing mailId

      state.mails[mailIndex].mailFolder === "draft" ? state.meta.draftMails.splice(state.meta.draftMails.findIndex(i => i === mailId), 1) : null; // Else increase by pushing mailId
