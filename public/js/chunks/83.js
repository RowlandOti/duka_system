...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  fetchEvents({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/apps/calendar/events").then(response => {
  ...
  fetchEventLabels({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/apps/calendar/labels").then(response => {
  ...
  editEvent({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].post(`/api/apps/calendar/event/${event.id}`, {
        event: event
      }).then(response => {
  ...
  removeEvent({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].delete(`/api/apps/calendar/event/${eventId}`).then(response => {
  ...
  eventDragged({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].post(`/api/apps/calendar/event/dragged/${payload.event.id}`, {
        payload: payload
      }).then(response => {
        // Convert Date String to Date Object
        let event = response.data;
