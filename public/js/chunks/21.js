  ...
  methods: {
    ...
    suggestionSelected() {
      if (this.currentSelected > -1) {
        const _this$currentSelected = this.currentSelected.split("."),
    ...
    increaseIndex(val = true) {
      const _this$currentSelected3 = this.currentSelected.split("."),
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout() {
      ...
      const firebaseCurrentUser = firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.auth().currentUser;

      if (firebaseCurrentUser) {
        firebase_app__WEBPACK_IMPORTED_MODULE_0___default.a.auth().signOut().then(() => {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    '$route'() {
      ...
      let scrollHeight = this.scrollHeight; // Collapse Group
...
const VxTour = () => __webpack_require__.e(/*! import() */ 91).then(__webpack_require__.bind(null, /*! @/components/VxTour.vue */ "./resources/js/src/components/VxTour.vue"));
