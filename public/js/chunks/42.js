...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    VuePerfectScrollbar: (vue_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_4___default()),
  ...
  computed: {
    ...
    senderImg() {
      return isSentByActiveUser => {
        if (isSentByActiveUser) return this.$store.state.AppActiveUser.photoURL;else return this.$store.getters['chat/contact'](this.userId).photoURL;
      };
    },
    ...
    isPinnedLocal: {
      ...
      set(val) {
        ...
        if (chatData) {
          ...
          this.$store.dispatch('chat/toggleIsPinned', payload).then(() => {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  fetchChats({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/apps/chat/chats").then(response => {
