...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created() {
    ...
    this.$http.get("/api/card/card-statistics/subscribers").then(response => {
      this.subscribersGained = response.data;
    }).catch(error => {
      console.log(error);
    }); // Revenue Generated

    this.$http.get("/api/card/card-statistics/revenue").then(response => {
      this.revenueGenerated = response.data;
    }).catch(error => {
      console.log(error);
    }); // Sales

    this.$http.get("/api/card/card-statistics/sales").then(response => {
      this.quarterlySales = response.data;
    }).catch(error => {
      console.log(error);
    }); // Orders - Statistics

    this.$http.get("/api/card/card-statistics/orders").then(response => {
    ...
    this.$http.get("/api/chat/demo-1/log").then(response => {
