...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created() {
    ...
    this.$http.get("/api/card/card-statistics/site-traffic").then(response => {
      this.siteTraffic = response.data;
    }).catch(error => {
      console.log(error);
    }); // Active Users

    this.$http.get("/api/card/card-statistics/active-users").then(response => {
      this.activeUsers = response.data;
    }).catch(error => {
      console.log(error);
    }); // Site Traffic gained

    this.$http.get("/api/card/card-statistics/newsletter").then(response => {
