...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    update_avatar() {// You can update avatar Here
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  fetchUsers({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get("/api/user-management/users").then(response => {
  ...
  fetchUser({}, userId) {
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(`/api/user-management/users/${userId}`).then(response => {
        resolve(response);
      }).catch(error => {
        reject(error);
      });
  ...
  removeRecord({
    ...
    return new Promise((resolve, reject) => {
      _axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].delete(`/api/user-management/users/${userId}`).then(response => {
