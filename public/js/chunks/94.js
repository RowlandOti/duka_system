...
//
//
const ItemGridView = () => __webpack_require__.e(/*! import() */ 10).then(__webpack_require__.bind(null, /*! ./components/ItemGridView.vue */ "./resources/js/src/views/apps/eCommerce/components/ItemGridView.vue"));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    cartButtonClicked(item) {
      if (this.isInCart(item.objectID)) this.$router.push('/apps/eCommerce/checkout').catch(() => {});else {
